...
public class PrimeGenerator {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
				...
				List<Long> primes = LongStream.rangeClosed(gen2.from, gen2.to).filter( (long n)->gen2.isPrime(n) )
				...
				long size = LongStream.rangeClosed(gen3.from, gen3.to).filter( (long n)->gen3.isPrime(n) )
